...
export function ResultsDashboard({ positions, candidates, votes, voters }: ResultsDashboardProps) {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        {/* Pagination Controls */}
        <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 flex items-center justify-between shadow-sm">
            <div className="pl-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-10 border-b lg:border-b-0 lg:border-r border-slate-100">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {results.map((r) => (
                  <div key={r.id} className="bg-blue-50 p-6 rounded-xl border border-blue-100 shadow-sm hover:shadow-md transition-all group flex flex-col items-center text-center">
